...
pi-control runs Pi-hole and Ansible outside the K3s cluster deliberately:
...
Trade-off: pi-control is a Pi 5 running two lightweight services. A Pi 3 would've been sufficient for the role.
